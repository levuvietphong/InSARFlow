...
class ALOS_Options:
     ...
     def __init__(self,  Mode, DownloadImages=None, UnzipData=None, 
                         ...
                         GenerateXML=None, RunIFGs=None, 
                         GenerateRoipac=None, CleanFiles=None,
                         TempBslnThres=None, PerpBslnThres=None,
          ...
          self.TemporalBaselineThreshold = TempBslnThres if TempBslnThres is not None else 1000        # [day]
          self.PerpendicularBaselineThreshold  = PerpBslnThres if PerpBslnThres is not None else 700    # [m]
...
class SEN1A_Options:
     ...
     def __init__(self,  DownloadImages=None, GenerateXML=None, RunIFGs=None, 
                         GenerateRoipac=None, CleanFiles=None, SelectRegion=None,                         
                         minLatitude=None, maxLatitude=None, minLongitude=None, maxLongitude=None,
                         TempBslnThres=None, OpenMP_Num_Threads=None):
          ...
          # Temporal and Perpendicular Baselines
          self.TemporalBaselineThreshold = TempBslnThres if TempBslnThres is not None else 30        # unit [day]
...
class ALOS_Lists:
     ...
     .. version:: 0.1.0
     """
     def __init__(self,  LogFiles = None, dateID = None,
                         LogScreen = None, ALOSScenes = None, 
